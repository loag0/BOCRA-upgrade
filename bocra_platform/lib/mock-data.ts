...
export const mockPublications: Publication[] = [
  {
    ...
    description:
      "BOCRA's comprehensive annual report covering regulatory activities and financial performance for 2024.",
  },
  {
    id: "pub-002",
    ...
    description:
      "Quality of Service monitoring results for mobile and fixed broadband operators, Q4 2025.",
  },
  {
    id: "pub-003",
    ...
    description:
      "The primary legislation governing BOCRA's mandate and regulatory powers.",
  },
  {
    id: "pub-004",
    ...
    description:
      "Data protection legislation replacing the 2018 Act. In effect from 29 October 2024.",
  },
  {
    id: "pub-005",
    ...
    description:
      "BOCRA invites public comment on the revised National Frequency Allocation Plan.",
  },
  {
    id: "pub-006",
    ...
    description:
      "The converged NFP/SAP licensing framework implemented September 2015.",
  },
  {
    id: "pub-007",
    ...
    description:
      "BOCRA's five-year strategic plan focused on digital transformation.",
  },
  {
    id: "pub-008",
    ...
    description:
      "Updated Quality of Service guidelines for mobile broadband. Operators must comply by 1 June 2026.",
  },
  {
    id: "pub-009",
    ...
    description:
      "Design, development, deployment and maintenance of the BOCRA website.",
  },
  {
    id: "pub-010",
    ...
    description:
      "Guidelines for consumer protection in the communications sector.",
  },
];
...
export const mockNews: NewsArticle[] = [
  {
    id: "news-001",
    title:
      "BOCRA Publishes Draft National Spectrum Policy 2026 for Public Consultation",
  ...
  },
  {
    id: "news-003",
    title:
      "Tender: Procurement of Automated Spectrum Management System Upgrade",
    category: "tender",
    excerpt:
  ...
  },
  {
    id: "news-007",
    title:
      "Public Notice: SIM Card Re-registration Deadline Extended to 30 June 2026",
    category: "public_notice",
    excerpt:
...
export const mockSpeeches: Speech[] = [
  {
    id: "speech-001",
    title:
      "Keynote Address: Digital Transformation and the Future of Regulation in Botswana",
