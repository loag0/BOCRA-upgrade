...
import bw.org.bocra.backend.news.NewsArticle;
import bw.org.bocra.backend.news.NewsArticleRepository;
import bw.org.bocra.backend.news.NewsCategory;
import bw.org.bocra.backend.operator.*;
import bw.org.bocra.backend.publication.Publication;
import bw.org.bocra.backend.publication.PublicationRepository;
import bw.org.bocra.backend.publication.PublicationType;
import bw.org.bocra.backend.operator.*;
import bw.org.bocra.backend.publication.*;
import bw.org.bocra.backend.speech.Speech;
import bw.org.bocra.backend.speech.SpeechRepository;
